...
TESTS_DO_MAIN = [
    ...
    ("search_objects",  "справочник сотрудников организации",             ["Сотрудники", "Пользователи", "ПолномочияСотрудников", "Организации"]),
    ("search_objects",  "регистр учета файлов и версий",                  ["ВерсииФайлов", "Файлы", "ТекстыВерсийФайлов", "ОбращенияКВерсиям"]),
    ...
    ("search_objects",  "шаблоны исходящих документов",                   ["ШаблоныДокументов", "Шаблоны", "ШаблоныДляСоздания", "ШаблоныПриглашения"]),
    ...
    ("search_all",      "штрихкодирование документов",                   ["Штрихкодирование", "Штрихкод", "НомерШтрихкода"]),
